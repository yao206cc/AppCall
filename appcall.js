const appcall = {
  ...
  */
  ...
  // 展示原生toast
  showToast(message) {
    JKEventHandler.callNativeFunction('showToast', {
      message: message
    }, '')
  },
  // 发送短信
  ...
  responseFail(stateCode) {
    JKEventHandler.callNativeFunction('responseFail', stateCode, '');
  },
  /**
   * 任务跳转页面
   * @param {*} type 任务类型
   */
  toOtherPageForTask(type) {
    JKEventHandler.callNativeFunction('toOtherPageForTask', type, '');
  },
};
